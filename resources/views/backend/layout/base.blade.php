...
<head>
    ...
    <!-- Icons Css -->
    <link href="{{ asset('assets/css/icons.min.css') }}?v={{rand(000,999)}}" rel="stylesheet" type="text/css" />
    <!-- App Css-->
    <link href="{{ asset('assets/css/app.min.css') }}?v={{rand(000,999)}}" id="app-style" rel="stylesheet" type="text/css" />
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <div class="container-fluid">
                    <div class="position" style="margin-top: -2%;
                margin-bottom: 2%;">
                        <div class="progress">
