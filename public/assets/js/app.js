! function (s) {
    ...
    function t(e) {
        1 == s("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (s("html").removeAttr("dir"), s("#dark-mode-switch").prop("checked", !1), s("#rtl-mode-switch").prop("checked", !1), s("#bootstrap-style").attr("href", asset('assets/css/bootstrap.min.css')), s("#app-style").attr("href", asset('assets/css/app.min.css')), sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == s("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e ? (s("html").removeAttr("dir"), s("#light-mode-switch").prop("checked", !1), s("#rtl-mode-switch").prop("checked", !1), s("#bootstrap-style").attr("href", asset('assets/css/bootstrap-dark.min.css')), s("#app-style").attr("href", asset('assets/css/app-dark.min.css')), sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == s("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e && (s("#light-mode-switch").prop("checked", !1), s("#dark-mode-switch").prop("checked", !1), s("#bootstrap-style").attr("href", asset('assets/css/bootstrap-rtl.min.css')), s("#app-style").attr("href", asset('assets/css/app-rtl.min.css')), s("html").attr("dir", "rtl"), sessionStorage.setItem("is_visited", "rtl-mode-switch"))
    }
    // function t(e) {
